 ...
 */
public class Jdk5PlayGround {
    public Jdk5PlayGround() {
    }
  ...
  public static Timestamp getCurrentTime()
   { 
    ...
    public static void main(String[] args) throws Exception{
      ...
      System.out.println("\u200d\uFE9F\uFEF4\uFEFC\uFEE5");
      System.out.println("\u0644\u0623\u0622\u0645");
      System.out.println("ABCD\u200d");      
      System.out.println("we \u202b ABCD with words");            
      System.out.println("ABCD \u206f123 EFG");
      System.out.println("\u202d öABCD");
      System.out.println("EFG \u200f ABCD");
      System.out.println("ABCD\u206a(EFG)HIG");
      System.out.println("ABCD(EF\u206cG)HIG");
/*
...
*/        
        ...
        //在java中要怎麼用printf
        System.out.printf("[%s]我今年%d歲11111111", "popcorny", 18);
        //加上換行
        System.out.printf(new java.util.Locale("UTFs-8"),"[%s]我今年%d歲22222222", "popcorny", 18).println();
        //另外也有類似sprintf的method
        String str = String.format("[%s] 屁啦~", "moliwangddddd");
